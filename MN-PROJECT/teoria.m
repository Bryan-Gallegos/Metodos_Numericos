...
% TEORIA MATLAB code for teoria.fig
...
% Last Modified by GUIDE v2.5 30-Nov-2020 07:49:41
...
% --- Executes on button press in metodSalir.
function metodSalir_Callback(hObject, eventdata, handles)
% hObject    handle to metodSalir (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(teoria);
raices
